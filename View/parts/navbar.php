        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav col-10">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?controller=moto&action=list">Gallerie</a>
                    </li>                    
                ...
                <div class=" d-flex justify-content-center col-2">
                        <?php
                        if ($this->currentUser) {
                            echo ('<a class="nav-link text-center text-warning float-end"> Bienvenue ' . $this->currentUser->getName(). '</a>');
                        }
                        ?>
                </div>
            </div>
